...
from .config import EFFECT, EXCLUDEAI, MAX, R18_MAX, SETU_PATH, SETU_R18, WITHDRAW_TIME, Config
...
setu_matcher = on_alconna(
    Alconna(
        ["/setu", "/色图", "/来点色图", "/色色", "/涩涩", "/来点色色", "setu", "色图", "来点色图", "色色", "涩涩", "来点色色"],
        Args["num", int, 1],
        Args["key", str, ""],
        Option(
            "-r|--r18",
